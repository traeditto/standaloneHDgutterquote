...
export default function ForContractorsPage() {
  return (
    <main className="sales-site contractor-landing growth-page">
      ...
      <footer className="sales-footer growth-footer"><div><Link href="/for-contractors" className="sales-brand"><span><Droplets size={19} /></span><b>HD Instant</b> Gutter Quote</Link><p>Turn website visitors into price-ready gutter leads.</p></div><div><b>Product</b><Link href="/instant-gutter-quote">Instant gutter quote</Link><Link href="/gutter-quote-software">Gutter quote software</Link></div><div><b>Account</b><Link href="/sign-up">Build free</Link><Link href="/sign-in">Sign in</Link></div><div><b>Support</b><a href="tel:+19044789272">(904) 478-9272</a></div><small>© 2026 HD Precision. Online gutter estimates are planning ranges subject to field verification.</small></footer>
    </main>
  )
}
