...
export function SeoIntentPage({
  ...
  return <main className="sales-site contractor-landing growth-page seo-intent-page">
    ...
    <footer className="sales-footer growth-footer"><div><Link href="/for-contractors" className="sales-brand"><span><House size={19} /><Sparkles size={11} /></span><b>HD Instant</b> Gutter Quote</Link><p>Turn your gutter website into a 24/7 estimator.</p></div><div><b>Software</b><Link href="/gutter-quote-software">Gutter quote software</Link><Link href="/instant-gutter-quote">Instant gutter quote</Link><Link href="/gutter-estimate-software">Estimate software</Link></div><div><b>Start</b><Link href="/sign-up">Build free</Link><Link href="/sign-in">Sign in</Link></div><div><b>Legal & support</b><Link href="/terms">Terms</Link><Link href="/privacy">Privacy</Link><Link href="/domain-terms">Managed domains</Link><a href="tel:+19044789272">(904) 478-9272</a></div><small>© 2026 HD Precision. Online estimates are planning ranges subject to contractor verification.</small></footer>
  </main>
}
