...
export function SeoIntentPage({
  ...
  return <main className="sales-site contractor-landing growth-page seo-intent-page">
    ...
    {comparisonIntent && <section className="seo-price-snapshot"><div><span>MANAGED LAUNCH</span><strong>$199<small>/month for 3 months</small></strong><p>$499 setup · $249/month after</p></div><div><span>BUILD AND TEST</span><strong>$0<small>before approval</small></strong><p>No credit card to configure and preview the contractor experience.</p></div><p>Rendering credit packs are separate from the base subscription so high-use contractors pay for the AI previews they use.</p></section>}
