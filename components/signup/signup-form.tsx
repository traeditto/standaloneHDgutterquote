    ...
    <section className="signup-panel">
      <div className="signup-card">
        ...
        <form onSubmit={submit}>
          ...
          {mode === "signup" && <label className="signup-terms"><input name="acceptedTerms" type="checkbox" required /><span><Check size={11} /></span><p>I agree to the <Link href="/terms" target="_blank">Terms of Service</Link>, and acknowledge the <Link href="/privacy" target="_blank">Privacy Policy</Link> and <Link href="/domain-terms" target="_blank">Managed Domain Terms</Link>. I will use only authorized test property data in the private demo.</p></label>}
